                ...
                <div class="col-lg-12">
                    <ul class="list-inline text-lg-right text-center">
                        <li class="list-inline-item">
                            <a href="mailto:info@companyname.com">info@kairukihospital.co.tz</a>
                        </li>
                        <li class="list-inline-item">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="/">
                    <img src="images\logo_full_0.png" alt="logo" width="218" height="168">
                </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="components\typography.html">Typography</a>
                                ...
                                <a class="dropdown-item" href="components\team-contents.html">Team Contents</a>
                            </div>
                        </li>
                        <li class="nav-item">
